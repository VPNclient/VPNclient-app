...
You are entering VDD (Visual-Driven Development) mode.

**References**:
- `flows/vdd.md` - Complete flow reference
- `flows/README.md` - Master flows documentation
- `flows/.templates/vdd/` - Templates for new flows

**Active Flows**:
- `flows/vdd-main-ui/` - 🟡 Visual Defined (Implementation Pending)
