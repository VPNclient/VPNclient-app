...
/// 20px dots spaced 14px apart, revealed by a clip window whose left/width
/// were captured across the six Figma frames (Start,1,2,3,4,5) — a
/// left-to-right reveal that collapses to the last dot before looping.
/// Values are the exact Figma pixel keyframes, not approximated.
class LoadingDots extends StatefulWidget {
  final Color color;
  const LoadingDots({super.key, this.color = AppColors.textPrimaryLight});
