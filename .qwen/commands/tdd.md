...
You are entering TDD (Tests-Driven Development) mode.

**References**:
- `flows/tdd.md` - Complete flow reference
- `flows/README.md` - Master flows documentation
- `flows/.templates/tdd/` - Templates for new flows

**Active Flows**:
- `flows/tdd-config-service/` - 🟡 Tests Defined (Implementation Pending)
