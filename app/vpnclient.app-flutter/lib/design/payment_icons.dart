...
/// real card-network marks. Every badge entry is a self-contained 24x24
/// rounded SVG (background + glyph baked in).
class PaymentIcons {
  PaymentIcons._();
  ...
  // Real card-network marks, for the card-entry screen's network detection.
