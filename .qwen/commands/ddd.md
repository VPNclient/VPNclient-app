...
You are entering DDD (Document-Driven Development) mode. 

**References**:
- `flows/ddd.md` - Complete flow reference
- `flows/README.md` - Master flows documentation
- `flows/.templates/ddd/` - Templates for new flows

**Active Flows**:
- `flows/ddd-config-service/` - ✅ Complete (ConfigService)
- `flows/ddd-onboarding/` - ✅ Complete (Onboarding System)
